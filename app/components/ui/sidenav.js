...
import { PiPersonArmsSpread, PiToolbox } from "react-icons/pi";
		...
		<>
			...
			>
				...
				<div className="flex flex-col px-11 font-medium">
					...
					>
						<PiToolbox size={46} />
						<p className="pl-6 text-3xl  hover:underline">Parent Toolkit</p>
					</Link>
			...
			>
				...
				<div className="flex flex-col px-10 font-semibold md:text-3xl text-2xl ">
					...
					>
						<PiToolbox size={46} />
						<p className="pl-6  hover:underline">Parent Toolkit</p>
					</Link>
